...
import org.terracotta.quartz.wrappers.*;
...
class DefaultClusteredJobStore implements ClusteredJobStore {
   ...
   * <code>{@link Trigger}</code> s that reference it.
   * </p>
   * 
  ...
  /**
   * <p>
   * Remove (delete) the <code>{@link Trigger}</code> with the given name.
   * </p>
   * 
  ...
  /**
   * <p>
   * Retrieve the <code>{@link JobDetail}</code> for the given <code>{@link org.quartz.Job}</code>.
   * </p>
   * 
...
@Override
  ...
  /**
   * <p>
   * Get the number of <code>{@link JobDetail}</code> s that are stored in the <code>JobsStore</code>.
   * </p>
   */
  @Override
  ...
  /**
   * <p>
   * Get the number of <code>{@link Trigger}</code> s that are stored in the <code>JobsStore</code>.
   * </p>
   */
  @Override
  ...
  /**
   * <p>
   * Get the number of <code>{@link Calendar}</code> s that are stored in the <code>JobsStore</code>.
   * </p>
   */
  @Override
  ...
  /**
   * <p>
   * Get the names of all of the <code>{@link Calendar}</code> s in the <code>JobStore</code>.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Get the names of all of the <code>{@link Trigger}</code> groups.
   * </p>
   */
  @Override
  ...
  /**
   * <p>
   * Pause the <code>{@link JobDetail}</code> with the given name - by pausing all of its current
   * <code>Trigger</code>s.
   * </p>
   */
  @Override
  ...
  /**
   * <p>
   * Pause all of the <code>{@link JobDetail}s</code> in the given group - by pausing all of their
   * <code>Trigger</code>s.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Resume (un-pause) the <code>{@link JobDetail}</code> with the given name.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Resume (un-pause) all of the <code>{@link JobDetail}s</code> in the given group.
   * </p>
   * <p>
   ...
   * the execution its associated <code>Job</code>), and that the <code>{@link JobDataMap}</code> in the
